    ...
    return (
      <div className="bg-[#302E28] mx-5 p-2">
        ...
        <div id="body" className="flex justify-center">
          ...
          <div id="to-do-list" className="min-w-96 m-4">
          ...
          <div id="features" className="mx-4">
            ...
            <div id="goals-notes" className="m-2">
              <div id="nav-goals-notes" className="flex">
                <h3 id="goals" className="py-2 px-3 text-[#E9E9E9] bg-[#707C87] rounded-t-lg">GOALS</h3>
                <h3 id="notes" className="py-2 px-3 text-[#3C3C3C] bg-[#B1C9DF] rounded-t-lg">NOTES</h3>
              </div>
              <div id="goals-notes-content" className="bg-[#D4DCFF] py-2 px-6">
                {/* change between "goals-content" and "notes-content" */}
                <ol id="goals-content" className="py-1">
